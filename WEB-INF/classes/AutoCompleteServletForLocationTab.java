...
public class AutoCompleteServletForLocationTab extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("complete")) {
            ...
            if (!targetId.equals("")) {
				...
				//ArrayList<String> locationsAlreadyAdded = new ArrayList<String>();
				//locationsAlreadyAdded.add("sampleeeee");
                ...
                while (it.hasNext())
				{
                    ...
                    if( // targetId matches location name
                         location.getLocationPin().toLowerCase().startsWith(targetId) ||
						...
						)
					{
						 ...
						 /*
						 for(String locationToCheck: locationsAlreadyAdded)
						 {
							 if(locationToCheck.equals(location.getLocationName()))
							 {
								 isAlreadyAdded = true;
							 }
						 }
						 */
							 ...
							 if(location.getLocationPin().toLowerCase().startsWith(targetId))
							 {
								sb.append("<location>");
								sb.append("<id>" + location.getLocationid() + "</id>");
								sb.append("<name>" + location.getLocationName() + "</name>");
								sb.append("<city>" + location.getLocationPin() + "</city>");
								sb.append("</location>");
								namesAdded = true;
							 }
							 else if(location.getLocationCity().toLowerCase().startsWith(targetId))
							 {
								sb.append("<location>");
								sb.append("<id>" + location.getLocationid() + "</id>");
								sb.append("<name>" + location.getLocationName() + "</name>");
							 ...
							 //locationsAlreadyAdded.add(location.getLocationName());
