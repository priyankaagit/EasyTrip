...
<html>
	...
	<body>
			...
			<div >
				...
				<div class="width">
					<br/>
					<h4 align = 'center'>We took care of your change of details</h4>
					<br/>
						 ...
						 <div align="center" style = "border-radius: 5px; background-color:#666;width: 400px;padding: 10px; margin-right:auto; margin-left:auto;">
							...
							<p><label style ="color: #FFFFFF; font-weight: bold;" for="fname">Your reservation <%=bId%> has been modified</label>
